...
const About = () => {
  return (
    <section className="text-white" id="about">
      <h2 className="mt-36 text-center text-white font-bold text-3xl">
        About Me
      </h2>
      {/* <div className="md:grid md:grid-cols-2 xl:grid-cols-1 gap-8 items-center py-8 px-4 xl:gap-12 sm:py-16 mt-8">
        <Image
          src={img1}
          alt="avatar image"
          className=" w-[200px] h-[200px] lg:w-[260px] lg:h-[260px] mx-auto rounded-xl"
        />
        <div className="2xl:grid 2xl:grid-cols-3 xl:w-full">
          <div>
            <p className=" text-justify md:w-8/12 2xl:w-11/12 2xl:ml-1 mx-auto lg:text-lg">
              ...
              issues, I now take great joy in writing, testing and debugging
              code, understanding the importance to get it right.
            </p>
          </div>
          <div>
            <p className="text-justify lg:w-8/12 2xl:w-11/12 mx-auto md:text-lg">
              For a long time, I was uncertain about my career path and hadn't
              considered software development as an option. Then, a few years
              ago while traveling, I met an inspirational software developer and
              stayed in touch through social media. Their advocacy for learning
              to code opened my eyes to the possibilities, prompting me to
              explore and experiment. I quickly discovered my passion for
          ...
          <div>
            <p className="text-justify lg:w-8/12 2xl:w-11/12  mx-auto md:text-lg">
              ...
              we had the opportunity to collaborate with an external
              stakeholder. A thoroughly enjoyable and extremely valuable
              experience.
            </p>
          </div>
        </div>
      ...
      {/* <div className="md:grid lg:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-8 ">
        <Image
          src={img1}
          alt="avatar image"
          className=" w-[200px] h-[200px] lg:w-[260px] lg:h-[260px] mx-auto rounded-xl"
